...
pub mod install_operation {
    ...
    impl ::protobuf::Enum for Type {
        ...
        fn from_str(str: &str) -> ::std::option::Option<Type> {
            match str {
                "REPLACE" => ::std::option::Option::Some(Type::REPLACE),
                "REPLACE_BZ" => ::std::option::Option::Some(Type::REPLACE_BZ),
                "MOVE" => ::std::option::Option::Some(Type::MOVE),
                "BSDIFF" => ::std::option::Option::Some(Type::BSDIFF),
                _ => ::std::option::Option::None
            }
        }
...
pub mod install_procedure {
    ...
    impl ::protobuf::Enum for Type {
        ...
        fn from_str(str: &str) -> ::std::option::Option<Type> {
            match str {
                "KERNEL" => ::std::option::Option::Some(Type::KERNEL),
                "PCR_POLICY" => ::std::option::Option::Some(Type::PCR_POLICY),
                _ => ::std::option::Option::None
            }
        }
